            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                  <img src="{{asset("web_assets/img/hde20.png")}}" alt="">
                </div>
              </div>
              <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="about-right-content">
                  <div class="section-heading">
                    <h6>Com a SOCIALIZA PLUS</h6>
                    <h4>POR QUE A <em>SOCIALIZA PLUS? </em></h4>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="section-heading  wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
              <h6>Nosso Serviços</h6>
              <h4>Entenda como <em>Funciona</em></h4>
              <div class="line-dec"></div>
            </div>
          </div>
          <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                    <div class="menu">
                      <div class="first-thumb active">
                        <div class="thumb">
                          <span class="icon"><img src="{{asset("web_assets/img/icon1.png")}}" alt="" ></span>
                           Escolha a Rede Social  
                        </div>
                      </div>
                      <div>
                        <div class="thumb">                 
                          <span class="icon"><img src="{{asset("web_assets/img/icon2.png")}}" alt=""></span>
                          O Serviço de preferência
                        </div>
                      </div>
                      <div>
                        <div class="thumb">                 
                          <span class="icon"><img src="{{asset("web_assets/img/icon3.png")}}" alt=""></span>
                          A Quantidade Exata
                        </div>
                      </div>
                      <div>
                        <div class="thumb">                 
                          <span class="icon"><img src="{{asset("web_assets/img/icon4.png")}}" alt=""></span>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6 align-self-center">
                                <div class="right-image">
                                  <img src="{{asset("web_assets/img/services-image.jpg")}}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div>
                          <div class="thumb">
                            <div class="row">
                              ...
                              <div class="col-lg-6 align-self-center">
                                <div class="right-image">
                                  <img src="{{asset("web_assets/img/services-image-02.jpg")}}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div>
                          <div class="thumb">
                            <div class="row">
                              ...
                              <div class="col-lg-6 align-self-center">
                                <div class="right-image">
                                  <img src="{{asset("web_assets/img/services-image-03.jpg")}}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div>
                          <div class="thumb">
                            <div class="row">
                              ...
                              <div class="col-lg-6 align-self-center">
                                <div class="right-image">
                                  <img src="{{asset("web_assets/img/services-image-04.jpg")}}" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <div class="row">
          <div class="col-lg-5">
            <div class="section-heading wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <h6>SERVIÇOS PARA REDE SOCIAIS</h6>
              <h4>Escolha sua <em>Rede Social</em></h4>
              <div class="line-dec"></div>
            </div>
          </div>
        </div>
                  ...
                  <div class="fill-form">
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="info-post">
                          <div class="icon">
                            <img src="{{asset("web_assets/img/phone-icon.png")}}" alt="">
                      ...
                      <div class="col-lg-4">
                        <div class="info-post">
                          <div class="icon">
                            <img src="{{asset("web_assets/img/email-icon.png")}}" alt="">
                      ...
                      <div class="col-lg-4">
                        <div class="info-post">
                          <div class="icon">
                            <img src="{{asset("web_assets/img/location-icon.png")}}" alt="">
