    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('dashboard.cupons.create') }}">
                    <button class="btn btn-primary mb-4">Adicionar Cupom</button>
                </a>
                @if ($errors->any())
